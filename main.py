...
class CalculaIpv4:
    def __init__(self, ip) -> None:
        ...
        self.mascara = self.calc_mascara_sub_rede(self.corpo_ip, self.bit_de_rede)
    ...
    def calc_mascara_sub_rede(self, ip, bit_rede):
        ...
        mascara = self.formatar_ip(self.binario_para_decimal(mascara), bit_rede)
        return mascara
